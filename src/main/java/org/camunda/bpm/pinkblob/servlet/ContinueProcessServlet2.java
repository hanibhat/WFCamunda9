...
public class ContinueProcessServlet2 extends HttpServlet {
	/**
		 * 
		 */
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (null == corrID) {
			...
			try {
				runtimeService.createMessageCorrelation("continueMessage2")
						.processInstanceVariableEquals("corrID", corrID).setVariable("contractLink", contractLink)
						.correlate();
