...
public class ContinueProcessServlet4 extends HttpServlet {
	/**
		 * 
		 */
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String furtherInputRequired = request.getParameter("furtherInputRequired");
		if (null == corrID) {
			out.println("<h2>Error</h2><p>Parameter corrID missing!</p>");
		} else {
			try {
				runtimeService.createMessageCorrelation("continue-process4")
						.processInstanceVariableEquals("corrID", corrID)
						.setVariable("furtherInputRequired", furtherInputRequired)
						.correlate();
